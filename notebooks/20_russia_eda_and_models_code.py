...
# ===== CELL 3 =====ID_COL = 'Регистрационный номер'
TARGET = 'is_bankrupt'
...
# ===== CELL 15 =====from sklearn.model_selection import StratifiedGroupKFold
...
print(cv)
res
# ===== CELL 16 =====best_roc_name = res['ROC-AUC test'].idxmax()
...
log(f'\n{verdict}')
print('\n' + verdict)
# ===== CELL 18 =====ensemble_pr = res.loc[['Random Forest', 'XGBoost'], 'PR-AUC test']
...
log(f'\n{verdict2}')
print('\n' + verdict2)
# ===== CELL 21 =====summary_path = REPORTS / 'ru_summary.md'
